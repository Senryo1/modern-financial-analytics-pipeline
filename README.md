...
| Power BI build guide | Completed |
...
| Document | Purpose |
|---|---|
| [`architecture.md`](docs/architecture.md) | Explains the project architecture and pipeline layers |
| [`data_dictionary.md`](docs/data_dictionary.md) | Describes datasets, fields, relationships, and analytical grain |
| [`business_rules.md`](docs/business_rules.md) | Documents data quality and business validation rules |
| [`code_walkthrough.md`](docs/code_walkthrough.md) | Explains the logic and design decisions behind the code |
| [`dashboard_requirements.md`](docs/dashboard_requirements.md) | Defines Power BI dashboard objectives, pages, KPIs, visuals, measures, and success criteria |
| [`powerbi_build_guide.md`](docs/powerbi_build_guide.md) | Provides the practical Power BI build steps, required files, table setup, DAX measures, page layout, and validation checklist |
...
~~~markdown
The Power BI dashboard will be built based on the documented requirements and practical build guide in:
...
```markdown
The build guide defines the files to load, recommended table names, DAX measures, page layouts, visual configuration, formatting recommendations, and validation checklist.
```

The dashboard will use the analytics-ready outputs generated 
...
The dashboard design will focus on portfolio monitoring, loan exposure, payment behavior, branch performance, advisor performance, and loan-level exploration.
...
1. Build the Power BI dashboard based on `docs/dashboard_requirements.md`.
2. Add dashboard screenshots to the repository.
3. Add a database loading layer for SQL Server, PostgreSQL, or Snowflake.
4. Convert transformation logic into dbt models.
5. Add dbt tests and documentation.
6. Add Airflow orchestration.
7. Add Docker for reproducible execution.
8. Add GitHub Actions for automated validation.
9. Add AI-assisted documentation or data quality summaries.
